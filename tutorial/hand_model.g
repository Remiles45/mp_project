...
#   color=[.2 .8 .2 0.5], type:ssBox size:[.05 .02 .05 0.0001] contact }
...
#   color=[.2 .8 .2 0.5],  type:ssBox size:[.02 .03 .05 0.004] contact }
...
shape collision index_tip_0 (index_tip) {
   color=[.8 .2 .2 0.5], type:ssBox size:[.02 .02 .05 0.004] contact }
