...
shape collision allegro_mount_0 (allegro_mount) {
   color=[.8 .2 .2 .5], rel=<T t(-0.0 -0.0425 -0.0425)>type=mesh mesh='../models/allegro_model/allegro_mount.stl' contact }
...
shape collision palm_link_0 (palm_link) {
   color=[.8 .2 .2 .5], rel=<T t(0 0 0 )>type=mesh mesh='../models/allegro_model/collision/base_link_biotac.stl' contact }
...
shape collision index_link_0_0 (index_link_0) {
   color=[.8 .2 .2 .5], type=mesh mesh='../models/allegro_model/collision/link_0.0.stl' contact }
...
shape collision index_link_1_0 (index_link_1) {
   color=[.8 .2 .2 .5], type=mesh mesh='../models/allegro_model/collision/link_1.0.stl' contact }
...
shape collision index_link_2_0 (index_link_2) {
   color=[.8 .2 .2 .5], type=mesh mesh='../models/allegro_model/collision/link_2.0.stl' contact }
...
shape collision index_link_3_0 (index_link_3) {
   color=[.8 .2 .2 .5], type=mesh mesh='../models/allegro_model/collision/link_3.0.stl' contact }
...
shape collision thumb_link_0_0 (thumb_link_0) {
   color=[.8 .2 .2 .5], type=mesh mesh='../models/allegro_model/collision/link_12.0_right.stl' contact }
...
shape collision thumb_link_1_0 (thumb_link_1) {
   color=[.8 .2 .2 .5], type=mesh mesh='../models/allegro_model/collision/link_13.0.stl' contact }
...
shape collision thumb_link_2_0 (thumb_link_2) {
   color=[.8 .2 .2 .5], type=mesh mesh='../models/allegro_model/collision/link_14.0.stl' contact }
...
shape collision thumb_link_3_0 (thumb_link_3) {
   color=[.8 .2 .2 .5], rel=<T t(0 0 -0.0)>type=mesh mesh='../models/allegro_model/collision/link_15.0.stl' contact }
...
shape collision index_tip_0 (index_tip) {
   color=[.8 .2 .2 .5], rel=<T t(-0.00277 0.0  -0.00545)>type=mesh mesh='../models/allegro_model/biotac/base_collision.stl' contact }
...
shape collision index_biotac_nail_0 (index_biotac_nail) {
   color=[.8 .2 .2 .5], rel=<T t(0.00 -0.00  -0.0)>type=mesh mesh='../models/allegro_model/biotac/nail_collision.stl'color=[1.0 1.0 1.0 1] colorName=White  contact }
...
shape collision index_biotac_tip_0 (index_biotac_tip) {
   color=[.8 .2 .2 .5], rel=<T t(-0.021 -0.002  -0.004)>type=mesh mesh='../models/allegro_model/biotac/contact_collision_small.stl'color=[0.0 0.8 .0 1] colorName=Green  contact }
