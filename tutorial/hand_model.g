...
shape visual allegro_mount_1 (allegro_mount) {
  rel=<T t(-0.0 -0.0425 -0.0425)>type=2 mesh='../models/allegro_model/allegro_mount.stl'colorName=Grey }

shape collision allegro_mount_0 (allegro_mount) {
   color=[.8 .2 .2 .5], rel=<T t(-0.0 -0.0425 -0.0425)>type=2 mesh='../models/allegro_model/allegro_mount.stl' contact }
body palm_link {mass=0.4154 inertiaTensor=[1e-4 0 0 1e-4 0 1e-4] }

shape visual palm_link_1 (palm_link) {
  rel=<T t(0 0 0 )>type=2 mesh='../models/allegro_model/base_link_biotac.stl'colorName=Black }

shape collision palm_link_0 (palm_link) {
   color=[.8 .2 .2 .5], rel=<T t(0 0 0 )>type=2 mesh='../models/allegro_model/collision/base_link_biotac.stl' contact }
...
shape visual index_link_0_1 (index_link_0) {
  type=2 mesh='../models/allegro_model/link_0.0.stl'colorName=Black }

shape collision index_link_0_0 (index_link_0) {
   color=[.8 .2 .2 .5], type=2 mesh='../models/allegro_model/collision/link_0.0.stl' contact }
...
shape visual index_link_1_1 (index_link_1) {
  type=2 mesh='../models/allegro_model/link_1.0.stl'colorName=Black }

shape collision index_link_1_0 (index_link_1) {
   color=[.8 .2 .2 .5], type=2 mesh='../models/allegro_model/collision/link_1.0.stl' contact }
...
shape visual index_link_2_1 (index_link_2) {
  type=2 mesh='../models/allegro_model/link_2.0.stl'colorName=Black }

shape collision index_link_2_0 (index_link_2) {
   color=[.8 .2 .2 .5], type=2 mesh='../models/allegro_model/collision/link_2.0.stl' contact }
...
shape visual index_link_3_1 (index_link_3) {
  type=2 mesh='../models/allegro_model/link_3.0.stl'colorName=Black }

shape collision index_link_3_0 (index_link_3) {
   color=[.8 .2 .2 .5], type=2 mesh='../models/allegro_model/collision/link_3.0.stl' contact }
...
shape visual thumb_link_0_1 (thumb_link_0) {
  type=2 mesh='../models/allegro_model/link_12.0_right.stl'colorName=Black }

shape collision thumb_link_0_0 (thumb_link_0) {
   color=[.8 .2 .2 .5], type=2 mesh='../models/allegro_model/collision/link_12.0_right.stl' contact }
...
shape visual thumb_link_1_1 (thumb_link_1) {
  type=2 mesh='../models/allegro_model/link_13.0.stl'colorName=Black }

shape collision thumb_link_1_0 (thumb_link_1) {
   color=[.8 .2 .2 .5], type=2 mesh='../models/allegro_model/collision/link_13.0.stl' contact }
...
shape visual thumb_link_2_1 (thumb_link_2) {
  type=2 mesh='../models/allegro_model/link_14.0.stl'colorName=Black }

shape collision thumb_link_2_0 (thumb_link_2) {
   color=[.8 .2 .2 .5], type=2 mesh='../models/allegro_model/collision/link_14.0.stl' contact }
...
shape visual thumb_link_3_1 (thumb_link_3) {
  rel=<T t(0 0 0.00)>type=2 mesh='../models/allegro_model/link_15.0.stl'colorName=Black }

shape collision thumb_link_3_0 (thumb_link_3) {
   color=[.8 .2 .2 .5], rel=<T t(0 0 -0.0)>type=2 mesh='../models/allegro_model/collision/link_15.0.stl' contact }
...
shape visual index_tip_1 (index_tip) {
  rel=<T t(-0.00277 0.0  -0.00545)>type=2 mesh='../models/allegro_model/biotac/base_visual.stl'color=[0.2 0.2 0.2 1] colorName=Grey }

shape collision index_tip_0 (index_tip) {
   color=[.8 .2 .2 .5], rel=<T t(-0.00277 0.0  -0.00545)>type=2 mesh='../models/allegro_model/biotac/base_collision.stl' contact }
...
shape visual index_biotac_nail_1 (index_biotac_nail) {
  rel=<T t(0.00 -0.00  -0.0)>type=2 mesh='../models/allegro_model/biotac/nail_visual.stl'color=[1 1 1 1] colorName=White }

shape collision index_biotac_nail_0 (index_biotac_nail) {
   color=[.8 .2 .2 .5], rel=<T t(0.00 -0.00  -0.0)>type=2 mesh='../models/allegro_model/biotac/nail_collision.stl'color=[1.0 1.0 1.0 1] colorName=White  contact }
...
shape visual index_biotac_tip_1 (index_biotac_tip) {
  rel=<T t(-0.021 -0.002  -0.004)>type=2 mesh='../models/allegro_model/biotac/contact_visual.stl'color=[0.0 0.8 .0 1] colorName=Green }

shape collision index_biotac_tip_0 (index_biotac_tip) {
   color=[.8 .2 .2 .5], rel=<T t(-0.021 -0.002  -0.004)>type=2 mesh='../models/allegro_model/biotac/contact_collision_small.stl'color=[0.0 0.8 .0 1] colorName=Green  contact }
...
joint allegro_mount_joint (allegro_mount palm_link) {
  type=JT_rigid A=<T t(0.108 0 -0.008) E(0 1.5708 0)>}
...
joint thumb_end_link_3 (thumb_link_3 thumb_link_3_offset) {
  type=JT_rigid A=<T t(0 0 0.015)>}
joint index_tip_joint (index_link_3 index_tip) {
  type=JT_rigid A=<T t(0.008 0.0 0.04) E(0 0 0)>}
joint index_biotac_nail_joint (index_tip index_biotac_nail) {
  type=JT_rigid A=<T t(-0.0022 0.0 -0.0055) E(-1.57 1.57 0)>}
joint index_biotac_joint (index_biotac_nail index_biotac_tip) {
  type=JT_rigid A=<T t(-0.021 -0.003 0.002) E(1.57 0. -2.791)>}
joint index_tip_bt (index_tip index_biotac_origin) {
  type=JT_rigid A=<T t(0.0005 0.00155 0.0155) E(0.0 -1.22129414408 0.0)>}
...
joint grasp_object_allegro (grasp_object allegro_mount) {
  type=JT_rigid A=<T t(0 0 0.01) E(0 0 0)>}
